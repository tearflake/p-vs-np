...
Because all the above rules produce results in linear time complexity of expressions they transform, we conclude that the whole procedure of **producing CNF from any formula takes a linear time complexity**.
